  ...
  def main(args: Array[String]): Unit = {
   ...
   val s1= env.fromElements(("t1",1000),("t2",2000),("t3",3000))
    ...
    s1.coGroup(s2)
      ...
      .apply(new MyCoGroupFunction).print
    env.execute
  }

}

class MyCoGroupFunction extends CoGroupFunction[Tuple2[String,Int],Tuple2[String,Int],String]{
  override def coGroup(iterable: lang.Iterable[(String, Int)], iterable1: lang.Iterable[(String, Int)], collector: Collector[String]): Unit ={
